...
function Page3CardComponent(props) {
    ...
    return mediaQueries.mobile ? (
      <div>
        <Page3MainCard
          ...
          btn2Icon={
            a.cartObject.get(ObjData.id) === 0 ? BtnAddIcon : BtnAddedIcon
          }
          btn3Icon={ViewIcon}
      ...
      Card.push(
        <>
          <Page3MainCard
            ...
            btn2Icon={
              a.cartObject.get(Page3Object[i].id) === 0
                ? BtnAddIcon
                : BtnAddedIcon
            }
            btn3Icon={ViewIcon}
          ...
          <Page3MainCard
            ...
            btn2Icon={
              a.cartObject.get(Page3Object[i + 1].id) === 0
                ? BtnAddIcon
                : BtnAddedIcon
            }
            btn3Icon={ViewIcon}
      ...
      Card.push(
        <>
          <Page3MainCard
            ...
            btn2Icon={
              a.cartObject.get(Page3Object[Page3Object.length - 1].id) === 0
                ? BtnAddIcon
                : BtnAddedIcon
            }
            btn3Icon={ViewIcon}
  ...
  return mediaQueries.mobile ? (
    <div className="CoverPage3TextBoxRow2">
      <Carousel autoplay>{Page3Object.map(CreateEntryPage3)}</Carousel>
    </div>
  ) : mediaQueries.tablet ? (
