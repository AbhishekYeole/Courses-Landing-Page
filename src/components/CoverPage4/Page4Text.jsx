    ...
    return (
        <div className="Page4TextOuterBox">
            ...
            <div className="FixedDiv"></div>
                ...
                <h2 className="Page4TextBoxH2Box">Most Popular Courses</h2>

                <p className="Page4TextBoxParagraph">Problems trying to resolve the conflict between the two major realms of Classical physics: Newtonian mechanics </p>
